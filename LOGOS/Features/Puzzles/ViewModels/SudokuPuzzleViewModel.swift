...
@MainActor
class SudokuPuzzleViewModel: ObservableObject {

    // MARK: - Published Properties
    let puzzleEngine: SudokuPuzzleEngine
    ...
    init(puzzleType: UserProgress.PuzzleType, difficulty: Int, userId: String) {
        ...
        self.userId = userId
        self.puzzleEngine = SudokuPuzzleEngine()
    ...
    private func handlePuzzleCompletion() {
        ...
        print("🎉 Sudoku puzzle completado y guardado")
    }
